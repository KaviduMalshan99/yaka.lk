<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('Pets - Farm Animals', app()->getLocale())); ?></h3>
    </div>
    <br>
    ...
    <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label"><?php echo e(GoogleTranslate::trans('Type of animal', app()->getLocale())); ?></label>
...
</div><?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\animals\farm-animals.blade.php ENDPATH**/ ?>