        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="footer-content">
                    <h3><?php echo e(GoogleTranslate::trans('Contact Us', app()->getLocale())); ?></h3>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="footer-content">
                    <h3><?php echo e(GoogleTranslate::trans('Quick Links', app()->getLocale())); ?></h3>
                    <ul class="footer-widget">
                        <li><a href="<?php echo e(route('about-us')); ?>"><?php echo e(GoogleTranslate::trans('About Us', app()->getLocale())); ?></a></li>
                        <li><a href="<?php echo e(route('contact-us')); ?>"><?php echo e(GoogleTranslate::trans('Contact Us', app()->getLocale())); ?></a></li>
                        <li><a href="<?php echo e(route('privacy-safety')); ?>"><?php echo e(GoogleTranslate::trans('Privacy & Safety', app()->getLocale())); ?></a></li>
                        
                        <li><a href="<?php echo e(route('tems-conditions')); ?>"><?php echo e(GoogleTranslate::trans('Tems & Conditions', app()->getLocale())); ?></a></li>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="footer-content">
                    <h3><?php echo e(GoogleTranslate::trans('General', app()->getLocale())); ?></h3>
                    <ul class="footer-widget">
                        <li><a href="<?php echo e(route('tips')); ?>"><?php echo e(GoogleTranslate::trans('Tips', app()->getLocale())); ?></a></li>
                        <li><a href="<?php echo e(route('boosting-ads')); ?>"><?php echo e(GoogleTranslate::trans('Boosting ads', app()->getLocale())); ?></a></li>
                        <li><a href="<?php echo e(route('ads-posting-allowances')); ?>"><?php echo e(GoogleTranslate::trans('Ad posting allowances', app()->getLocale())); ?></a></li>
                        <li><a href="<?php echo e(route('ad-posting-criteria')); ?>"><?php echo e(GoogleTranslate::trans('Ad posting criteria', app()->getLocale())); ?></a></li>
                        <li><a href="<?php echo e(route('banner-ads')); ?>"><?php echo e(GoogleTranslate::trans('Banner Ads', app()->getLocale())); ?></a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="footer-card-content">
                    ...
                    <div class="footer-app" style="display: flex;flex-wrap: wrap;">
                        <span style="width: 100%"><?php echo e(GoogleTranslate::trans('Coming soon', app()->getLocale())); ?></span>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\layout\layout.blade.php ENDPATH**/ ?>