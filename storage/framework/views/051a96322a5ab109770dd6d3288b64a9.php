<form class="product-widget-form" action="<?php echo e(route('ads.location',[ $nowSearchSubCategoryUrl==0 ? $category->url : $nowSearchSubCategoryUrl, $nowSearchLocation ?? ''])); ?>" id="filter" method="post">
    ...
    <div class="col-md-6 col-lg-12">
        <div class="product-widget">
            <h6 class="product-widget-title"><?php echo e(GoogleTranslate::trans('House Size', app()->getLocale())); ?></h6>
            <div class="product-widget-group">
    ...
    <div class="col-md-6 col-lg-12">
        <div class="product-widget">
            <h6 class="product-widget-title"> <?php echo e(GoogleTranslate::trans('Bathrooms ', app()->getLocale())); ?></h6>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\filters\property\houses-for-sale.blade.php ENDPATH**/ ?>