            ...
            <div class="row content-reverse">
                <div class="col-lg-4">
                    ...
                    <button type="button" class="common-card number" data-toggle="modal" data-target="#number">
                        <h3><?php echo e(GoogleTranslate::trans($data->user->phone_number, app()->getLocale())); ?><h3>
                    ...
                    <div class="common-card">
                        <div class="card-header">
                            <h5 class="card-title"><?php echo e(GoogleTranslate::trans('author info', app()->getLocale())); ?></h5>
                        </div>
                        <div class="ad-details-author">
                            ...
                            <div class="author-meta">
                                ...
                                ?>
                                <h5><?php echo e(GoogleTranslate::trans('joined', app()->getLocale())); ?>: <?php echo e($joined); ?></h5>
                            </div>
                            ...
                            <ul class="author-list">
                                ...
                                ?>
                                <li><h6><?php echo e(GoogleTranslate::trans('total ads ', app()->getLocale())); ?></h6><p><?php echo e($total_ads); ?></p></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <?php if( count($topads) >4 ): ?>
                        ...
                        <div class="common-card">
                            <div class="card-header">
                                <h5 class="card-title"> <?php echo e(GoogleTranslate::trans('featured ads', app()->getLocale())); ?></h5>
                            </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="common-card">
                        ...
                        <h5 class="ad-details-address"><?php echo e($data->main_location->name_en .' / '.$data->sub_location->name_en); ?></h5>
                      ...
                      <?php if($data->user_id  == Auth()->user()->id && isset(Session::get('user')['id'])): ?>
                          
                     <!-- BUMP UP CARD -->
                    <div class="common-card">
                        <a href="<?php echo e(route('ads.bump-up',$data->id)); ?>" style="display: block;text-align: center;background: #FF0000;color: white;padding: 11px 0;border-radius: 7px;}">Jump up Now</a>
                    </div>
                    ...
                    <div class="common-card">
                        <div class="card-header">
                            <h5 class="card-title"><?php echo e(GoogleTranslate::trans('Specification', app()->getLocale())); ?></h5>
                        </div>
                        <ul class="ad-details-specific">
                            <li>
                                <h6><?php echo e(GoogleTranslate::trans('Price', app()->getLocale())); ?>:</h6>
                                <p>LKR <?php echo e($data->price); ?></p>
                            </li>
                            <li>
                                <h6><?php echo e(GoogleTranslate::trans('District', app()->getLocale())); ?>:</h6>
                                <p><?php echo e($data->main_location->name_en); ?></p>
                            </li>
                            <li>
                                <h6><?php echo e(GoogleTranslate::trans('city', app()->getLocale())); ?>:</h6>
                                <p><?php echo e($data->sub_location->name_en); ?></p>
                            </li>
                            <li>
                                <h6><?php echo e(GoogleTranslate::trans('Category', app()->getLocale())); ?>:</h6>
                                <p><?php echo e($data->category->name); ?></p>
                            </li>

                            <li>
                                <h6><?php echo e(GoogleTranslate::trans('Sub Category', app()->getLocale())); ?>:</h6>
                    ...
                    <div class="common-card">
                        <div class="card-header">
                            <h5 class="card-title"><?php echo e(GoogleTranslate::trans('Description', app()->getLocale())); ?></h5>
                        </div>
                        <p class="ad-details-desc"><?php echo e(GoogleTranslate::trans($data->description, app()->getLocale())); ?></p>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-center-heading">
                        <h2><?php echo e(GoogleTranslate::trans('Related', app()->getLocale())); ?>  <span><?php echo e(GoogleTranslate::trans('Ads', app()->getLocale())); ?></span></h2>
                        <p><?php echo e(GoogleTranslate::trans('Lorem ipsum dolor sit amet consectetur adipisicing elit aspernatur illum vel sunt libero voluptatum repudiandae veniam maxime tenetur.', app()->getLocale())); ?></p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="center-50">
                        <a href="ad-column3.html" class="btn btn-inline">
                            ...
                            <span><?php echo e(GoogleTranslate::trans('view all related', app()->getLocale())); ?></span>
                        </a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('web.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\ads-details.blade.php ENDPATH**/ ?>