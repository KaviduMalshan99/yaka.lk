<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('Electronics - TV & Video Accessories', app()->getLocale())); ?></h3>
    </div>
    <br>
    <br>
   ...
   <br><br>
    ...
    <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label"><?php echo e(GoogleTranslate::trans('Device Type', app()->getLocale())); ?></label>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\electronics\tv-video-accessories.blade.php ENDPATH**/ ?>