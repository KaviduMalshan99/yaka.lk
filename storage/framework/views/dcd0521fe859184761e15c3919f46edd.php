  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 pt-5 pb-5">
        <h2 class="text-center mt-5 mb-4"><?php echo e(GoogleTranslate::trans('Banner Ads', app()->getLocale())); ?></h2>
        <p class="text-center mb-4"><?php echo e(GoogleTranslate::trans('Banner ads are a great way to attract and engage with your target audience.', app()->getLocale())); ?></p>
        ...
        <p class="text-center mb-4"><?php echo e(GoogleTranslate::trans("Since skyscraper banner ads are long and thin, achieving the right balance in your banner design is essential. You'll want to include your company logo, your value proposition, and a strong call to action—all of which require adequate space. This is where strong banner ad design skills come in, along with insights into what resonates with your target audience.", app()->getLocale())); ?></p>

        <p class="text-center mt-4"><?php echo e(GoogleTranslate::trans('Purchase your banners for your business today!', app()->getLocale())); ?></p>
      </div>
    </div>
  </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('web.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\banner-ads.blade.php ENDPATH**/ ?>