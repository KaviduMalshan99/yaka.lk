<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('Electronics - Mobile Phone Accessories', app()->getLocale())); ?></h3>
    </div> <?php echo $__env->make('web.components.AdsForms.common-fechas', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <br><br>
    <div class="row mt-4">
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\electronics\mobile-phone-accessories.blade.php ENDPATH**/ ?>