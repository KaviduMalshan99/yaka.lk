                ...
                <div class="col-lg-7">
                    <div class="dash-header-right">
                        <div class="dash-focus dash-list">
                            <h2><?php echo e(GoogleTranslate::trans('Post', app()->getLocale())); ?></h2>
                            <p><?php echo e(GoogleTranslate::trans('Your Ads', app()->getLocale())); ?></p>
                        </div>
                        <div class="dash-focus dash-book">
                            <h2><?php echo e(GoogleTranslate::trans('Need', app()->getLocale())); ?></h2>
                            <p> <?php echo e(GoogleTranslate::trans('To Buy ', app()->getLocale())); ?></p>
                        </div>
                        <div class="dash-focus dash-rev">
                            <h2><?php echo e(GoogleTranslate::trans('Boost', app()->getLocale())); ?></h2>
                            <p><?php echo e(GoogleTranslate::trans('Your Ads', app()->getLocale())); ?></p>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\Blocks\dashboard-nav.blade.php ENDPATH**/ ?>