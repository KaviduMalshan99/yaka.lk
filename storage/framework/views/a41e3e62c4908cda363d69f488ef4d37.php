<form class="product-widget-form" action="<?php echo e(route('ads.location',[ $nowSearchSubCategoryUrl==0 ? $category->url : $nowSearchSubCategoryUrl, $nowSearchLocation ?? ''])); ?>" id="filter" method="post">
    ...
    <div class="col-md-6 col-lg-12">
        <div class="product-widget">
            <h6 class="product-widget-title"><?php echo e(GoogleTranslate::trans('Year of Manufacture</h6>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\filters\vehicles\vans.blade.php ENDPATH**/ ?>