<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('Motor vehicles - Vans', app()->getLocale())); ?></h3>
    </div>
    <div class="row mt-4">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <input value="<?php echo e(old('manufacture_year')); ?>" onchange="selecterror('manufacture_year')" type="number" name="manufacture_year"class="form-control" placeholder="When was your car manufatured">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                ...
                <input value="<?php echo e(old('engine_capacity')); ?>"onchange="selecterror('engine_capacity')"type="number"name="engine_capacity" class="form-control" placeholder="What is Engine capacity (cc)  of car">
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\vehicles\vans.blade.php ENDPATH**/ ?>