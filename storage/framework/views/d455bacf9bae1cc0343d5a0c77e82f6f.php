<form class="product-widget-form" action="<?php echo e(route('ads.location',[ $nowSearchSubCategoryUrl==0 ? $category->url : $nowSearchSubCategoryUrl, $nowSearchLocation ?? ''])); ?>" id="filter" method="post">
    ...
    <div class="col-md-6 col-lg-12">
        <div class="product-widget">
            <h6 class="product-widget-title"><?php echo e(GoogleTranslate::trans('Brands</h6>
                ...
                <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="product-widget-item">
                        <div class="product-widget-checkbox">
                            <input  name="brand[]" <?php if(in_array($brand->id, $retrievedArray)): ?> checked <?php endif; ?> value="{{ $brand->id); ?>" type="checkbox" id="<?php echo e($brand->url); ?>">
                        </div>
    ...
    <div class="col-md-6 col-lg-12">
        <div class="product-widget">
            <h6 class="product-widget-title"><?php echo e(GoogleTranslate::trans('Item type</h6>
            <ul class="product-widget-list product-widget-scroll">
                <?php
                ...
                <?php $__currentLoopData = $typs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $typ): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="product-widget-item">
                        <div class="product-widget-checkbox">
                            <input <?php if(in_array($typ->id, $retrievedArray)): ?> checked <?php endif; ?>  name="type[]" value="{{ $typ->id); ?>" type="checkbox" id="">
                        </div>
    ...
    <div class="col-md-6 col-lg-12">
        <div class="product-widget">
            <h6 class="product-widget-title"><?php echo e(GoogleTranslate::trans('Capacity', app()->getLocale())); ?></h6>
            <ul class="product-widget-list product-widget-scroll">
                <?php
                    $retrievedArray = Session::get('filter_capacity') ?? [];
                ?>
                <?php $__currentLoopData = config('constants.CAPACITY'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $capacity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="product-widget-item">
                        <div class="product-widget-checkbox">
                            <input <?php if(in_array($key, $retrievedArray)): ?> checked <?php endif; ?>  name="capacity[]" value="<?php echo e($key); ?>" type="checkbox" id="">
                        </div>
                        <label class="product-widget-label" for="{">
                            <span class="product-widget-type" style="color: #0D0A0A"><?php echo e($capacity); ?></span>
                            <span class="product-widget-number"></span>
                        </label>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\filters\electronics\air-conditions-electrical-fittings.blade.php ENDPATH**/ ?>