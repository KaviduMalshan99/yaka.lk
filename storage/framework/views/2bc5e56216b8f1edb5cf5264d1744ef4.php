<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('Motor vehicles - Cars', app()->getLocale())); ?></h3>
    </div>
    <div class="row mt-4">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label"><?php echo e(GoogleTranslate::trans('Trim / Edition', app()->getLocale())); ?></label>
    ...
    <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label"><?php echo e(GoogleTranslate::trans('Fuel type', app()->getLocale())); ?></label>
                <select onchange="selecterror('fuel_Type')"name="fuel_Type" class="form-control custom-select">
                    <?php $__currentLoopData = config('constants.FUEL_TYPE'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$fuel_Type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
                        <?php if(old('fuel_Type', 'default_value') == $key): ?> selected <?php endif; ?>
                         value="<?php echo e($key); ?>"><?php echo e($fuel_Type); ?></option>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php if($errors->has('fuel_Type')): ?>
                    <div class="alert alert-danger" id="fuel_Type">
                        <?php echo e($errors->first('fuel_Type')); ?>
    ...
    <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label"><?php echo e(GoogleTranslate::trans('Transmission', app()->getLocale())); ?></label>
                ...
                <?php $__currentLoopData = config('constants.TRANSMISSION'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $transmission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
                        <?php if($transmission == 'none'): ?> selected <?php endif; ?>
                        <?php if(old('transmission', 'default_value') == $key): ?> selected <?php endif; ?>
                        value="<?php echo e($key); ?>"><?php echo e($transmission); ?></option>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                </select>
                <?php if($errors->has('transmission')): ?>
                    <div class="alert alert-danger" id="transmission">
                        <?php echo e($errors->first('transmission')); ?>
    ...
    <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label"><?php echo e(GoogleTranslate::trans('Body type', app()->getLocale())); ?></label>
                <select onchange="selecterror('type')" name="type"class="form-control custom-select">

                    <?php $__currentLoopData = config('constants.BODY_TYPE'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option
                        <?php if(old('type', 'default_value') == $key): ?> selected <?php endif; ?>
                        value="<?php echo e($key); ?>"><?php echo e($type); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\vehicles\cars.blade.php ENDPATH**/ ?>