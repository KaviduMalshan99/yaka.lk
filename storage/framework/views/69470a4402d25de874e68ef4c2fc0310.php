<div style="background-color:rgb(92, 2, 2) !important; padding: 6px 12px 6px 12px !important;" class="header-content">
    ...
    <div style="color: #ffffff !important;" class="header-form row">
        <div class="col-md-4 col-sm-10 d-flex"><i style="margin-right:15px !important;" class="fa-solid fa-phone mt-1"></i> <span><?php echo e(GoogleTranslate::trans('Contact',app()->getLocale())); ?> : 070 5 321 321</span></div>
        <div class="col-md-4 col-sm-10 d-flex"><i style="margin-right:15px !important;"  class="fa-solid fa-envelope  mt-1"></i> <span><?php echo e(GoogleTranslate::trans('Email', app()->getLocale())); ?> : Info@yaka.lk</span></div>
        <div class="col-md-4 col-sm-10 d-flex"><i style="margin-right:15px !important;"  class="fa-solid fa-location-dot  mt-1"></i> <span><?php echo e(GoogleTranslate::trans('Loaction', app()->getLocale())); ?> : Colombo 10, Sri Lanka</span>
        </div>
    </div>
        ...
        <div class="header-content">
            ...
            <form class="header-form" method="get" action="<?php echo e(route('search')); ?>">
                <div class="header-search">
                    ...
                    <input required type="text" value="<?php echo e($_GET['search'] ?? ""); ?>" placeholder="<?php echo e(GoogleTranslate::trans('Search,  Category Name , sub category Name , district  you needs...', app()->getLocale())); ?>" name="search">
                </div>
            </form>
            ...
            <div class="header-right">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-inline post-btn">
                        <i class="fas fa-user"></i>
                        <span><?php echo e(GoogleTranslate::trans('Login / Register', app()->getLocale())); ?></span>
                    </a>
                <?php endif; ?>
                <a href="<?php echo e(route('user.dashboard.ad-post.main')); ?>" class="btn btn-inline post-btn">
                    <i class="fas fa-plus-circle"></i>
                    <span><?php echo e(GoogleTranslate::trans('post your ad', app()->getLocale())); ?></span>
                </a>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views/web/Blocks/nav.blade.php ENDPATH**/ ?>