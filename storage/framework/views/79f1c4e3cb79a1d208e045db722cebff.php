<div class="feature-card">
    ...
    <div class="feature-content" style="padding: 25px; position: absolute;background: none;border-radius: 0px 0px 8px 8px;" >
        <ol class="breadcrumb feature-category">
            <li class="breadcrumb-item"><a href="<?php echo e(route('ads',[$ads->category->url])); ?>"><?php echo e(GoogleTranslate::trans($ads->category->name, app()->getLocale())); ?></a>
            </li>
            <li class="breadcrumb-item active"
                aria-current="page"><?php echo e(GoogleTranslate::trans($ads->subcategory->name, app()->getLocale())); ?></li>
        </ol>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views/web/components/cards/slideAdsCards.blade.php ENDPATH**/ ?>