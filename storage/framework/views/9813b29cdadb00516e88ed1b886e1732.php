<div style="background-color:rgb(92, 2, 2) !important; padding: 6px 12px 6px 12px !important;" class="header-content">
    ...
    <div style="color: #ffffff !important;" class="header-form row">
        <div class="col-4"><i style="margin-right:15px !important;" class="fa-solid fa-phone  "></i> <span><?php echo e(GoogleTranslate::trans('Contact',app()->getLocale())); ?> : 070 5 321 321</span></div>
        <div class="col-4"><i style="margin-right:15px !important;"  class="fa-solid fa-envelope "></i> <span><?php echo e(GoogleTranslate::trans('Email', app()->getLocale())); ?> : Info@yaka.lk</span></div>
        <div class="col-4"><i style="margin-right:15px !important;"  class="fa-solid fa-location-dot "></i> <span><?php echo e(GoogleTranslate::trans('Loaction', app()->getLocale())); ?> : Colombo 10, Sri Lanka</span>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\Blocks\nav.blade.php ENDPATH**/ ?>