    ...
    <section class="suggest-part" style="padding-top: 0 ;margin-top: 100px;">
        <div class="container" style="display: flex;flex-wrap: wrap;justify-content: space-evenly;">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('ads',[$category->url])); ?>" class="suggest-card" style="width: 165px !important ;margin-bottom: 20px">
                        <img src="<?php echo e(asset('images/Category/'.$category->image)); ?>" alt="car">
                        <h6><?php echo e(GoogleTranslate::trans($category->name, app()->getLocale())); ?></h6>
                        <?php
                            $adsCount = \App\Models\Ads::where('cat_id', $category->id )->where('status',1)->count();
                        ?>
                        <p>(<?php echo e($adsCount); ?> <?php echo e(GoogleTranslate::trans('ads', app()->getLocale())); ?>)</p>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="section-side-heading">
                        <h2><?php echo e(GoogleTranslate::trans('Find your needs in our best ', app()->getLocale())); ?><span><?php echo e(GoogleTranslate::trans('Super Ads', app()->getLocale())); ?></span></h2>
        ...
        <section class="section feature-part" style="padding-top: 0;margin-top: 100px;">
            <div class="container">
                <div class="row">
                    <div class="col-md-5 col-lg-5">
                        <div class="section-side-heading">
                            <h2><?php echo e(GoogleTranslate::trans('Find your needs in our best ', app()->getLocale())); ?><span><?php echo e(GoogleTranslate::trans('Top Ads', app()->getLocale())); ?></span></h2>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-center-heading">
                        ...
                        <p style="
                        width: 100%;
                    "><?php echo e(GoogleTranslate::trans('Lorem ipsum dolor sit amet consectetur adipisicing elit aspernatur illum vel sunt libero
    ...
    <section class="section trend-part" style="padding-top: 0;margin-top: 100px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-center-heading">
                        <h2><?php echo e(GoogleTranslate::trans('Popular Trending ', app()->getLocale())); ?><span><?php echo e(GoogleTranslate::trans('Ads', app()->getLocale())); ?></span></h2>
                        <p style="
                        width: 100%;
                    "><?php echo e(GoogleTranslate::trans('Lorem ipsum dolor sit amet consectetur adipisicing elit aspernatur illum vel sunt libero
                            voluptatum repudiandae veniam maxime tenetur.', app()->getLocale())); ?></p>
                        ...
                        <div class="category-card">
                            ...
                            <ul class="category-list">
                                <?php $__currentLoopData = $topcategory->subcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <?php if($key <= 4): ?>
                                        <li><a href="<?php echo e(route('ads',[$subcategory->url])); ?>"><h6><?php echo e(GoogleTranslate::trans($subcategory->name, app()->getLocale())); ?></h6>
...
<?php echo $__env->make('web.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\index.blade.php ENDPATH**/ ?>