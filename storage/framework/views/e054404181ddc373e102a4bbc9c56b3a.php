<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('Motor vehicles - Auto Services', app()->getLocale())); ?></h3>
    </div>
    <br>
    <div class="row">
    <div class="col-lg-12">
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\vehicles\auto-services.blade.php ENDPATH**/ ?>