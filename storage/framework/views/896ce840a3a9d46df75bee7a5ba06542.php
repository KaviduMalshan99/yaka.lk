            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="footer-content">
                    ...
                    <ul class="footer-widget">
                        ...
                        <li><a href="<?php echo e(route('tems-conditions')); ?>">Tems & Conditions</a></li>
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="footer-content">
                    ...
                    <ul class="footer-widget">
                        ...
                        <li><a href="<?php echo e(route('boosting-ads')); ?>">Boosting ads</a></li>
                        <li><a href="<?php echo e(route('ads-posting-allowances')); ?>">Ad posting allowances</a></li>
                        <li><a href="<?php echo e(route('ad-posting-criteria')); ?>">Ad posting criteria</a></li>
                        <li><a href="<?php echo e(route('banner-ads')); ?>">Banner Ads</a></li>
                    </ul>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\user\layout.blade.php ENDPATH**/ ?>