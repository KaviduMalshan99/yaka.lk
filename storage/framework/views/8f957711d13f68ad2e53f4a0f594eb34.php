                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="admin-form" method="post" action="<?php echo e(route('dashboard.categories.update-category', $category->url)); ?>" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" required  class="form-control" id="count" name="free_add_count" value="<?php echo e(old('free_add_count') ?? $category->free_add_count); ?>" placeholder="Free add count">
                        </div>
                        <?php endif; ?>
...
<?php echo $__env->make('adminPanel.layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\adminPanel\categoryManagement\update.blade.php ENDPATH**/ ?>