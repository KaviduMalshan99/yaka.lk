<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('Education - Tuition', app()->getLocale())); ?></h3>
    </div>
    ...
    <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label"> <?php echo e(GoogleTranslate::trans('Tuition Type', app()->getLocale())); ?></label>
...
</div><?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\education\tuition.blade.php ENDPATH**/ ?>