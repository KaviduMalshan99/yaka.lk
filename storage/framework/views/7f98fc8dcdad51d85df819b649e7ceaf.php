<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('Electronics -   Electrical Fittings', app()->getLocale())); ?></h3>
    </div>
    <br>
    ...
    <br>
        ...
        <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label"><?php echo e(GoogleTranslate::trans('Capacity', app()->getLocale())); ?></label>
                ...
                <?php $__currentLoopData = config('constants.CAPACITY'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$capacity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option <?php if(old('capacity', 'default_value') == $key): ?> selected <?php endif; ?>  value="<?php echo e($key); ?>"><?php echo e($capacity); ?></option>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\electronics\air-conditions-electrical-fittings.blade.php ENDPATH**/ ?>