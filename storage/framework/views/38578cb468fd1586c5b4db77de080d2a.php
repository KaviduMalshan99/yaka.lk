<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('leisure,kids items & sports - children items', app()->getLocale())); ?></h3>
    </div>
   ...
   <br><br>
    ...
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <?php $__currentLoopData = config('constants.GENDER'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option 
               
                value="<?php echo e($key); ?>"><?php echo e($gender); ?></option>
...
</div><?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\hobby-sports-and-kids\children-s-items.blade.php ENDPATH**/ ?>