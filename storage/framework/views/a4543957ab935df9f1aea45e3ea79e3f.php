    ...
    <section class="dashboard-part">
        <div class="container">
            ...
            <div class="row mt-5" >
                ...
                <div class="col-lg-8">
                    <h1><?php echo e(GoogleTranslate::trans('Hello,', app()->getLocale())); ?> <?php echo e(Session::get('user')['first_name']); ?></h1>
                    <h1><?php echo e(GoogleTranslate::trans('welcome to Yaka.lk', app()->getLocale())); ?></h1>
                    <p>  <?php echo e(GoogleTranslate::trans(" We're thrilled to have you here. As a valued member of our community, you now have access to the largest online marketplace in Sri Lanka, where countless opportunities await you.
...
<?php echo $__env->make('web.user.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\user\dashboard.blade.php ENDPATH**/ ?>