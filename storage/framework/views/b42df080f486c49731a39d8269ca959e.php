<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('Home & Garden - Furniture', app()->getLocale())); ?></h3>
    </div>
   <br>
   ...
   <div class="row mt-4">
    ...
    <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label"><?php echo e(GoogleTranslate::trans('Funiture Type', app()->getLocale())); ?></label>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\home-garden\furniture.blade.php ENDPATH**/ ?>