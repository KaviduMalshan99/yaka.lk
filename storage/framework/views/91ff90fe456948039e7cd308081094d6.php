   ...
   style="margin-bottom: 10px">
    ...
    <div class="product-content">
        <ol class="breadcrumb product-category">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('ads',[$ads->category->url])); ?>"><?php echo e(GoogleTranslate::trans($ads->category->name, app()->getLocale())); ?></a></li>
            <li class="breadcrumb-item active" aria-current="page"><?php echo e(GoogleTranslate::trans($ads->subcategory->name, app()->getLocale())); ?></li>
        </ol>
        ...
        <h5 class="product-title">
            ...
            <div class="product-meta">
                <span><i class="fas fa-map-marker-alt"></i><?php echo e($ads->main_location->name_en); ?>, <?php echo e($ads->sub_location->name_en); ?></span>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views/web/components/cards/adCards.blade.php ENDPATH**/ ?>