...
<body onload="returnForm()" style="display: flex; justify-content: center; height: 100vh; align-items: center;">
    ...
    <script>
       function returnForm() {           
        ...
        const payment = {
            ...
            checkValue: "<?php echo e($checkValue); ?>", // Pass the PHP variable to JavaScript
            orderDescription: "Payment",
            invoiceId: "<?php echo e($invoiceId); ?>",
            merchantKey: "2850686EDCB8570C", // Ensure this key is valid
            customerFirstName: "<?php echo e($customerFirstName); ?>",
            customerLastName: "<?php echo e($customerLastName); ?>",
            customerMobilePhone: "<?php echo e($customerMobilePhone); ?>",
            customerEmail: "<?php echo e($customerEmail); ?>",
            billingAddressStreet: "Main street",
            billingAddressCity: "<?php echo e($billingAddressCity); ?>",
    ...
    try {
        payablePayment(payment, function(response) {
            ...
            fetch('<?php echo e(route('user.notify')); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\user\payment.blade.php ENDPATH**/ ?>