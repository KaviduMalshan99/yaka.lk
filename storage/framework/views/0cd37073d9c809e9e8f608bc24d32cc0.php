<div class="adpost-card">
    <div class="adpost-title">
        <h3><?php echo e(GoogleTranslate::trans('Electronics - TVs', app()->getLocale())); ?></h3>
    </div>
    <br>
   ...
   <br><br>
    ...
    <div class="col-lg-12">
            <div class="form-group">
                <label class="form-label"><?php echo e(GoogleTranslate::trans('Screen Size (optional)', app()->getLocale())); ?></label>
                <select value="<?php echo e(old('ssize')); ?>" onchange="selecterror('ssize')" name="ssize" class="form-control custom-select">
                   <?php $__currentLoopData = config('constants.SCREEN_SIZE'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$screen_size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php if($screen_size == 'none'): ?> selected <?php endif; ?> value="<?php echo e($key); ?>"><?php echo e($screen_size); ?></option>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php if($errors->has('ssize')): ?>
                    <div class="alert alert-danger" id="ssize">
                        <?php echo e($errors->first('ssize')); ?>
...
<?php /**PATH C:\xampp\htdocs\yaka.lk\resources\views\web\components\AdsForms\electronics\tvs.blade.php ENDPATH**/ ?>