            ...
            <div class="row content-reverse">
                <div class="col-lg-4">
                    ...
                    <button type="button" class="common-card number" data-toggle="modal" data-target="#number">
                        <h3>{{ GoogleTranslate::trans($data->user->phone_number, app()->getLocale()) }}<h3>
                    ...
                    <div class="common-card">
                        <div class="card-header">
                            <h5 class="card-title">{{ GoogleTranslate::trans('author info', app()->getLocale()) }}</h5>
                        </div>
                        <div class="ad-details-author">
                            ...
                            <div class="author-meta">
                                ...
                                @endphp
                                <h5>{{ GoogleTranslate::trans('joined', app()->getLocale()) }}: {{$joined}}</h5>
                            </div>
                            ...
                            <ul class="author-list">
                                ...
                                @endphp
                                <li><h6>{{ GoogleTranslate::trans('total ads ', app()->getLocale()) }}</h6><p>{{$total_ads}}</p></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    @if( count($topads) >4 )
                        ...
                        <div class="common-card">
                            <div class="card-header">
                                <h5 class="card-title"> {{ GoogleTranslate::trans('featured ads', app()->getLocale()) }}</h5>
                            </div>
...
{{--                            </a>--}}
                      ...
                      @if ($data->user_id  == Auth()->user()->id && isset(Session::get('user')['id']))
                    ...
                    <div class="common-card">
                        <div class="card-header">
                            <h5 class="card-title">{{ GoogleTranslate::trans('Specification', app()->getLocale()) }}</h5>
                        </div>
                        <ul class="ad-details-specific">
                            <li>
                                <h6>{{ GoogleTranslate::trans('Price', app()->getLocale())}}:</h6>
                                <p>LKR {{$data->price}}</p>
                            </li>
                            <li>
                                <h6>{{ GoogleTranslate::trans('District', app()->getLocale())}}:</h6>
                                <p>{{$data->main_location->name_en}}</p>
                            </li>
                            <li>
                                <h6>{{ GoogleTranslate::trans('city', app()->getLocale())}}:</h6>
                                <p>{{$data->sub_location->name_en}}</p>
                            </li>
                            <li>
                                <h6>{{ GoogleTranslate::trans('Category', app()->getLocale())}}:</h6>
                                <p>{{$data->category->name}}</p>
                            </li>

                            <li>
                                <h6>{{ GoogleTranslate::trans('Sub Category', app()->getLocale())}}:</h6>
                    ...
                    <div class="common-card">
                        <div class="card-header">
                            <h5 class="card-title">{{ GoogleTranslate::trans('Description', app()->getLocale()) }}</h5>
                        </div>
                        <p class="ad-details-desc">{{GoogleTranslate::trans($data->description, app()->getLocale())}}</p>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-center-heading">
                        <h2>{{ GoogleTranslate::trans('Related', app()->getLocale()) }}  <span>{{GoogleTranslate::trans('Ads', app()->getLocale())}}</span></h2>
                        <p>{{GoogleTranslate::trans('Lorem ipsum dolor sit amet consectetur adipisicing elit aspernatur illum vel sunt libero voluptatum repudiandae veniam maxime tenetur.', app()->getLocale())}}</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="center-50">
                        <a href="ad-column3.html" class="btn btn-inline">
                            <i class="fas fa-eye"></i>
                            <span>{{GoogleTranslate::trans('view all related', app()->getLocale())}}</span>
                        </a>
                    </div>
                </div>
            </div>
