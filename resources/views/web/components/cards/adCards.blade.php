...
{{--            <img  src="{{asset('images/Ads/'.$ads->mainImage)}}" alt="product">--}}
    ...
    <div class="product-content">
        <ol class="breadcrumb product-category">
            ...
            <li class="breadcrumb-item"><a href="{{route('ads',[$ads->category->url])}}">{{GoogleTranslate::trans($ads->category->name, app()->getLocale())}}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{GoogleTranslate::trans($ads->subcategory->name, app()->getLocale())}}</li>
        </ol>
